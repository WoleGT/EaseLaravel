			...
			<div class="row">
				<div class="col-md-6 col-lg-3 mb-4 mb-md-0">
					...
					<ul class="ftco-footer-social p-0">
						...
						<li class="ftco-animate"><a href="#" data-toggle="tooltip" data-placement="top" title="https://www.linkedin.com/company/ease-cs/" target="_blank"><span class="fa fa-linkedin"></span></a></li>						
				...
				<div class="col-md-6 col-lg-3 pl-lg-5 mb-4 mb-md-0">
					...
					<ul class="list-unstyled">
						...
						<li><a href="{{ url('/seevices') }}" class="py-2 d-block">Services</a></li>
