   ...
   <div class="collapse navbar-collapse" id="ftco-nav">
     <ul class="navbar-nav ml-auto">
       <li class="nav-item active"><a href="{{ url('/') }}" class="nav-link">Home</a></li>
					...
					<li class="nav-item cta"><a href="{{ url('/contact') }}" class="nav-link">Book Consultation</
     </ul>
   </div>
 </div>
</nav>
   ...
   <div class="col-md-6 col-lg-2.4">
    <div class="causes causes-2 text-center ftco-animate">
     <div class="text p-3">
       ...
       <p><a href="contact.html" class="btn btn-light w-100">Request Service</a></p>
     </div>
   </div>
 </div>
 <div class="col-md-6 col-lg-2.4">
  <div class="causes causes-2 text-center ftco-animate">
   <div class="text p-3">
     ...
     <p>
      <a href="contact.html" class="btn btn-light w-100">Request Service</a></p>
   </div>
 </div>
</div>
<div class="col-md-6 col-lg-2.4">
...
<div class="col-md-6 col-lg-2.4">
  <div class="causes causes-2 text-center ftco-animate">
   ...
   <div class="text p-3">
     ...
     <p>
     <a href="contact.html" class="btn btn-light w-100">Request Service</a>
   </div>
 </div>
</div>
