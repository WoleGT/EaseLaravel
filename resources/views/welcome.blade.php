	...
	<!-- end alert message -->
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="input-wrap">
											...
											<input type="text"  name="full_name" class="form-control" placeholder="Abraham Ibrahim..." Required>
										</div>
									</div>
								</div>
								<div class="col-md-12">
				...
				<div class="col-md-7 wrap-about py-5">
					<div class="heading-section pr-md-5 pt-md-5">
						...
						<h2 class="mb-4">We are here to help every child with special need, autism, associated syndrome, co-occuring syndrome, and learning disability.</h2>
					...
					<p><a href="workwithus.html" class="btn btn-secondary btn-outline-secondary">Become A Volunteer</a></p>
				</div>
			</div>
		</div>
	</section>
				...
				<div class="col-md-6 col-lg-3">
					<div class="causes causes-2 text-center ftco-animate">
						...
						<div class="text p-3">
							...
							<div class="goal mb-4">
								<!-- <p><span>35</span> groups in UK | Nigeria</p> -->
								<!-- <div class="progress" style="height:20px">
									<div class="progress-bar progress-bar-striped" style="width:35%; height:20px">35%</div>
								</div> -->
							</div>
							<p><a href="services.html" class="btn btn-light w-100">Learn more</a></p>
						</div>
					</div>
				</div>
				<div class="col-md-6 col-lg-3">
					<div class="causes causes-2 text-center ftco-animate">
						<a href="#" class="img w-100" style="background-image: url(images/causes_2.jpg);"></a>
						<div class="text p-3">
							<h2><a href="#">Training Sessions</a></h2>
							<p>Care and Therapy Review (CTR) and DISCO.</p>
							<div class="goal mb-4">
								<!-- <p><span>60 Sessions</span> Online | Onsite</p>
								<div class="progress" style="height:20px">
				...
				<div class="col-md-6 col-lg-3">
					<div class="causes causes-2 text-center ftco-animate">
						...
						<div class="text p-3">
							...
							<div class="goal mb-4">
								<!-- <p><span>95</span> at Home | School Setting</p>
								<div class="progress" style="height:20px">
				...
				<div class="col-md-6 col-lg-3">
					<div class="causes causes-2 text-center ftco-animate">
						...
						<div class="text p-3">
							...
							<div class="goal mb-4">
								<!-- <p><span>115</span> Assessed | Cared for</p>
								<div class="progress" style="height:20px">
									<div class="progress-bar progress-bar-striped" style="width:115%; height:20px">115%</div>
								</div> -->
							</div>
							<p><a href="contact.html" class="btn btn-light w-100">learn more</a></p>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="item">
							<div class="testimony-wrap d-flex">
								...
								<div class="text pl-4">
									...
									<p>Far far away, behind the word mountains, far from the countries Vokalia</p>
									<p class="name">Bimbo Akeredolu</p>
						...
						<div class="item">
							<div class="testimony-wrap d-flex">
								...
								<div class="text pl-4">
									...
									<p>Far far away, behind the word mountains, far from the countries Vokalia</p>
									<p class="name">Abimbola Moses</p>
									<span class="position">Techprenuer</span>
								</div>
							</div>
						</div>
						<div class="item">
						...
						<div class="item">
							<div class="testimony-wrap d-flex">
								...
								<div class="text pl-4">
									...
									<p>Far far away, behind the word mountains, far from the countries Vokalia</p>
									<p class="name">Folorunsho Alakija</p>
									<span class="position">Businesswoman</span>
								</div>
							</div>
						</div>
			...
			<div class="row d-flex">
				<div class="col-md-6 col-lg-3 d-flex ftco-animate">
					<div class="blog-entry align-self-stretch">
						<a href="blog-single.html" class="block-20" style="background-image: url('images/causes_1.jpg');">
						</a>
						<div class="text p-4">
							<div class="meta mb-2">
							...
							<p>a condition related to brain development that affects how people see others and socialize with them</p>
			...
			<div class="row">
				...
				<div class="col-md-6 col-lg-3 mb-4 mb-md-0">
					...
					<h4>Latest Blog Posts</h4>
   						 <ul>
        					@foreach($recentPosts as $post)
           					 <li><a href="{{ route('posts.show', $post->id) }}">{{ Str::limit($post->title, 30) }}</a></li>
        					@endforeach
   					 </ul>


						<a class="img mr-4 rounded" style="background-image: url(images/causes_2.jpg);"></a>
						<div class="text">
