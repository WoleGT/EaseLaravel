...
// Blog routes
Route::get('/blog', [PostController::class, 'index'])->name('posts.index'); // List all posts
Route::get('/blog/{post}', [PostController::class, 'show'])->name('posts.show'); // Show individual post


// Admin blog post creation
Route::middleware(['auth:admin'])->group(function () {
    Route::get('/admin/posts/create', [PostController::class, 'create'])->name('posts.create'); // Show form to create a new post    
    Route::post('/admin/posts', [PostController::class, 'store'])->name('posts.store'); // Store a new post
    Route::get('admin/blog', [PostController::class, 'index'])->name('admin.posts.index'); // List all posts in admin
    Route::get('/blog/{post}/edit', [PostController::class, 'edit'])->name('admin.posts.edit'); // Show form to edit a post
    Route::put('/blog/{post}', [PostController::class, 'update'])->name('admin.posts.update'); // Update a post
    Route::delete('/blog/{post}', [PostController::class, 'destroy'])->name('admin.posts.destroy'); // Delete a post
